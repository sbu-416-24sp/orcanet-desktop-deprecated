...
const marketData: File[] = [
  ...
  {
    cid: "bagaaifcavabu6fzheerrmtxbbwv7jjhc3kaldmm7lbnvfopyrthcvod4m6ygpj3unrcggkzhvcwv5wnhc5ufkgzlsji7a",
    name: "demo10",
    links: 47,
  },
  {
    cid: "QmSnuWmxptJZdLJpKRarxBMS2Ju2oANVrgbr2xWbie4123",
    name: "demo11",
    links: 23,
  },
  {
    cid: "QmSnuWmxptJZdLJpKRarxBMS2Ju2oANVrgbr2xWbie9b45",
    name: "demo12",
    links: 13,
  },
];
